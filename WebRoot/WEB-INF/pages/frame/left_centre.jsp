...
<html>
  <head>
    <title>CRM Frame left centre</title>
    <link href="${pageContext.request.contextPath}/css/frame/left/dtree.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/frame/left/dtree.js"></script>
